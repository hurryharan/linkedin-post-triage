...
function flatten(record) {
  ...
  return {
    ...
    commentDraft: record.commentPosted || record.commentDraft,
    commentStatus: record.commentPosted ? 'posted' : record.manualDone?.comment ? 'done' : '',
    reviewStatus: record.reviewStatus,
    unsaveStatus: record.unsaveStatus,
